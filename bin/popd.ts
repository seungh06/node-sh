...
import { DIRECTORY_STACK, load_index, load_stacks } from 'binary/dirs'
import { cd } from 'binary/cd'

export const popd_options: defined.binary_options = [
        {
                short: 'n', description: 'Suppresses the normal change of directory when removing\n directories from the stack, so only the stack is manipulated.'
        }
]

export const popd: defined.asm<string[]> = (main, ...args) => {
