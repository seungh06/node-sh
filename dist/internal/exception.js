...
class InternalError extends Error {
    ...
    render_code(storage, line) {
        const content = fs_1.default.readFileSync(storage, 'utf-8').replace(/\r/g, '').split('\n');
    ...
    get_header(storage, line) {
        return [
            ...
            exports.constants.FG_GRAY + path_1.default.basename(storage) + ':' + line + exports.constants.NEW_LINE
        ].join(exports.constants.NEW_LINE + exports.constants.TAB);
    }
    render(storage, line) {
