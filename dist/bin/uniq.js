...
const uniq = (main, ...args) => {
    ...
    if (output && node_fs_1.default.existsSync(output) && node_fs_1.default.statSync(output).isDirectory()) {
    ...
    const res = node_fs_1.default.readFileSync(input, 'utf-8').split('\n')
        ...
        .join('\n');
    if (output)
        node_fs_1.default.writeFileSync(output, res);
